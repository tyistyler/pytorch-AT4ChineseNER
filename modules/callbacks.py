...
class EvaluateCallback(Callback):
    ...
    def on_train_end(self):
        result_txt = open('result/result.txt', 'a', encoding='utf-8')
        if self.best_test_sofar:
            ...
            result_txt.write("Best test performance(may not correspond to the best dev performance):{} achieved at Epoch:{}.".format(self.best_test_sofar, self.best_test_epoch))
            result_txt.write("\n")
        if self.best_dev_test:
            ...
            result_txt.write("Best test performance(correspond to the best dev performance):{} achieved at Epoch:{}.".format(self.best_dev_test, self.best_dev_epoch))
            result_txt.write("\n")
        result_txt.close()
