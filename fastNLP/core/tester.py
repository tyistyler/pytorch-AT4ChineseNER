...
class Tester(object):
            ...
            with torch.no_grad():
                ...
                with inner_tqdm(total=len(data_iterator), leave=False, dynamic_ncols=True) as pbar:
                    ...
                    for indices, batch_x, batch_y in data_iterator:
                        ...
                        pred_dict = self._data_forward(self._predict_func, is_ner=True, batch_x=batch_x, cws_batch_x=cws_batch_x)
    ...
    def _data_forward(self, func, is_ner, batch_x, cws_batch_x):
